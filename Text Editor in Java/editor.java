...
public class editor extends JFrame//inherite JFrame in my class 
{
	...
	JMenu Avantika = new JMenu("Avantika University");
	JMenu Aman = new JMenu("reported by Aman");
	...
	public editor()
	{
		...
		menuBar.add(HELP);
		Avantika.setMnemonic(KeyEvent.VK_H);
		menuBar.add(Avantika);
		Aman.setMnemonic(KeyEvent.VK_H);
		menuBar.add(Aman);
		...
		menuclear.addActionListener( new ActionListener(){public void actionPerformed(ActionEvent e)
			{
				area.setText(null);
			}
		});
